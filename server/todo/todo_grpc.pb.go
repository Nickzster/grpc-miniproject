...
type TodoClient interface {
	...
	ReadTodos(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TodoItems, error)
}
...
func (c *todoClient) ReadTodos(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TodoItems, error) {
	out := new(TodoItems)
...
type TodoServer interface {
	...
	ReadTodos(context.Context, *Empty) (*TodoItems, error)
...
func (UnimplementedTodoServer) ReadTodos(context.Context, *Empty) (*TodoItems, error) {
...
func _Todo_ReadTodos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServer).ReadTodos(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
